...
popHeart = new BodymovinLayer
	superLayer: heartButtonCore
	width: 54
	height: 54
	jsonPath: './assets/pop.json'
	looping: false
	autoplay: false
	opacity: 0
...
heartButtonFloatSend = () ->
	popHeart.opacity = 1
	rotationHeart.opacity = 0
	popHeart.anim.goToAndPlay(0, true)
	...
	heartButton.animate
		...
		options: 
			...
			curve: 'ease-in'
	Utils.delay 0.6, ->
		heartButtonCore.scale = 1
		heartButtonCore.y = 0
# 		heartButton.opacity = 1
		popHeart.opacity = 0
		rotationHeart.opacity = 1
		heartButtonCore.opacity = 0
		heartButtonCore.scale = 0.3
		Utils.delay 0.01, ->
			heartButton.y = 18
			heartButton.x = 335
