...
curveEffect.html = """
	<svg viewBox='0 -72 375 375' version = "1.1">
		...
		<path id ="curve1" d ="M 36 0 q 187.5 0 303 0 l 0 64 l -303 0" fill="url(#grad1)"/>
	</svg>
"""
...
curveEffectCover.html = """
	<svg viewBox='0 -72 375 375' version = "1.1">
		...
		<path id ="curve2" d ="M 36 0 q 187.5 0 303 0 l 0 64 l -303 0" fill="url(#grad2)"/>
	</svg>
"""
...
effectHandler = () ->
	...
	yVal = Math.min(Math.max(dragHandler.y - handlerOriginY, -168), 0)
	document.querySelector('.svgBox #curve1').setAttribute('d','M 36 0 q '+xVal+' '+yVal+' 303 0 l 0 64 l -303 0')
	document.querySelector('.svgBox #curve2').setAttribute('d','M 36 0 q '+xVal+' '+yVal+' 303 0 l 0 64 l -303 0')
...
dragArea.on Events.MouseUp, (event)->
	...
	light.stateSwitch('vanish')
	buttonExtend.visible = true
	buttonExtend.stateSwitch('extend')
	buttonExtend.animate('normal')
	curveEffect.opacity = 0
	dragEffect.animate('vanish').on Events.AnimationEnd, ->
# 		dragEffect.stateSwitch('vanish')
